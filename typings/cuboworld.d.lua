...
--- Чтобы LSP подхватил типы по всему проекту: в настройках LuaLS добавьте в
---   Lua.workspace.library  путь к папке typings (или укажите эту папку в Lua.workspace.userThirdParty).
--- В скрипте: ---@type cuboworld
